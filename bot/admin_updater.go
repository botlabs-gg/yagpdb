...
var (
	confMainServer         = config.RegisterOption("quackpdb.main.server", "Main servquack used for various purposes, like assigning people with a certquack role as bot admins", int64(0))
