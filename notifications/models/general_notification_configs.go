...
var (
	generalNotificationConfigAllColumns            = []string{"guild_id", "created_at", "updated_at", "join_server_enabled", "join_server_channel", "join_dm_enabled", "join_dm_msg", "leave_enabled", "leave_channel", "topic_enabled", "topic_channel", "censor_invites", "join_server_msgs", "leave_msgs"}
	generalNotificationConfigColumnsWithoutDefault = []string{"guild_id", "created_at", "updated_at"}
	generalNotificationConfigColumnsWithDefault    = []string{"join_server_enabled", "join_server_channel", "join_dm_enabled", "join_dm_msg", "leave_enabled", "leave_channel", "topic_enabled", "topic_channel", "censor_invites", "join_server_msgs", "leave_msgs"}
