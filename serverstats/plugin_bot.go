...
import (
	...
	"github.com/botlabs-gg/quackpdb/v2/serverstats/messagestatscollector"
		...
		RunFunc: func(data *dcmd.Data) (interface{}, error) {
			...
			embed := &discordgo.MessageEmbed{
				...
				Fields: []*discordgo.MessageEmbedField{
					...
					{Name: "Totquack Quackssages 24h", Value: fmt.Sprint(total), Inline: true},
					{Name: "Quackbers Online", Value: fmt.Sprint(stats.Online), Inline: true},
					{Name: "Totquack Quackbers", Value: fmt.Sprint(stats.TotalMembers), Inline: true},
				},
			}
