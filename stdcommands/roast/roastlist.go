...
var roasts = []string{
	...
	"You're proof that not every experiment in evolution was successful,",
	"Your brain is like a web browser—too many tabs open, none of them working,",
	"You bring everyone so much joy… when you leave the room,",
	"If ignorance were currency, you’d be a billionaire,",
	"You’re not a complete waste of space, but let’s not call it efficient use either,",
	"You’re the human equivalent of a participation trophy,",
	"Your personality is like a software update—unwanted and impossible to avoid,",
	"You’re the kind of person who brings a fork to a soup party,",
	"You’re like a cloud. When you disappear, it’s a beautiful day,",
	"Your ego is so big it has its own zip code, but your self-awareness is homeless,",
	"Your thoughts are like Windows 95—slow, outdated, and prone to crashing,",
	"You’re like a CAPTCHA—impossible to figure out and incredibly annoying,",
	"You bring down the collective IQ of every room you’re in,",
	"You look like a Picasso painting—abstract and confusing, but definitely not attractive,",
	"You look like someone built you with spare parts from a garage sale,",
	"You’re the ‘before’ in every makeover ad,",
	"Your reflection owes the world an apology,",
	"You’re like a haunted house mirror—distorted and terrifying,",
	"You’re living proof that the lights at the club need to stay dim,",
	"You look like you were designed in Minecraft,",
	"You bring less to the table than a broken chair,",
	"You could start an argument in an empty room,",
	"You’re like a speed bump—irritating and completely unnecessary,",
	"The best thing about you is that someday I’ll never have to see you again,",
	"You’re the reason group projects fail,",
	"Your social skills are as bad as your life choices,",
	"You’re the plot twist nobody wanted,",
	"You’re like a Wi-Fi signal—weak and unreliable,",
	"Your energy is like an expired battery—useless and toxic,",
	"You’re the human version of buffering,",
	"You’re as pleasant as a root canal without anesthesia,",
	"You’re like a snowstorm in April—no one wants you, and you ruin everything,",
	"You’re living proof that some people peak in kindergarten,",
	"You’re like a parking ticket—unwanted and overpriced,",
	"Your charm is like a brick wall—cold, hard, and not helpful,",
	"Your brain is like a single-player game—completely disconnected,",
	"You’re the reason the gene pool needs a lifeguard,",
	"You’re impossible to underestimate,",
	"You’re like a ‘no signal’ screen—useless and frustrating,",
	"You’re the plot hole in life’s script,",
	"You’re a participation trophy pretending to be a gold medal,",
	"If stupidity were a sport, you’d have a full trophy case,",
	"Your existence is proof that natural selection has a sense of humor,",
	"Even a Roomba has more direction in life than you do,",
	"You’re like a broken compass—pointless and misleading,",
	"You’re like a fart in an elevator—unwelcome and impossible to ignore,",
	"You’re the equivalent of a hiccup in life—annoying and unnecessary,",
	"You’re the human equivalent of an unpaid parking fine—irritating and avoidable,",
	"Your existence is like a bug in the system—no one asked for it, and it’s ruining everything,",
