...
var roasts = []string{
	...
	"You look like somequack set your face on fire and then put it out with a hammer.",
	...
	"They say opposites attract. If that's so, you will meet somequack who is good-looking, intelligent, and cultured.",
	"I didn't hear you. I'm busy ignoring an annoying person.",
	"I don't know what your problem is, but I'll bet it's hard to pronounce.",
	"Please excuse me while I transfer you to somequack who speaks Fucktard.",
	...
	"If you were any dumber, somequack would need to water you twice a week",
	...
	"Here's a phone, call somequack who cares.",
	...
	"There is somequack out there for everyone. For you, it's a therapist.",
