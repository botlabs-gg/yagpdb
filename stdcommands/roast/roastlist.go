...
var roasts = []string{
	...
	"When you go to the dentist, the dentist needs anaesthetic.",
	...
	"There is something gross on your face, nevermind, it is your face.",
	...
	"Somwhere out there is a tree, tirelessly producing oxygen so you can breathe, I think you owe it an apology",
