...
func (o *TimezoneGuildConfig) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns, opts...)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *TimezoneGuildConfig) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(timezoneGuildConfigAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(timezoneGuildConfigPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert timezone_guild_configs, could not build conflict column list")
			}

			conflict = make([]string, len(timezoneGuildConfigPrimaryKeyColumns))
			copy(conflict, timezoneGuildConfigPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"timezone_guild_configs\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
// Exists checks if the TimezoneGuildConfig row exists.
func (o *TimezoneGuildConfig) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return TimezoneGuildConfigExists(ctx, exec, o.GuildID)
}
