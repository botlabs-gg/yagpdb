...
type ModerationConfig struct {
	...
	UnwarnSendToModlog          null.Bool        `boil:"unwarn_send_to_modlog" json:"unwarn_send_to_modlog,omitempty" toml:"unwarn_send_to_modlog" yaml:"unwarn_send_to_modlog,omitempty"`
	UnwarnIncludeWarnReason     null.Bool        `boil:"unwarn_include_warn_reason" json:"unwarn_include_warn_reason,omitempty" toml:"unwarn_include_warn_reason" yaml:"unwarn_include_warn_reason,omitempty"`
...
var ModerationConfigColumns = struct {
	...
	UnwarnSendToModlog          string
	UnwarnIncludeWarnReason     string
}{
	GuildID:                     "guild_id",
	...
	UnwarnSendToModlog:          "unwarn_send_to_modlog",
	UnwarnIncludeWarnReason:     "unwarn_include_warn_reason",
}
...
var ModerationConfigTableColumns = struct {
	...
	UnwarnSendToModlog:          "moderation_configs.unwarn_send_to_modlog",
	UnwarnIncludeWarnReason:     "moderation_configs.unwarn_include_warn_reason",
}
...
var ModerationConfigWhere = struct {
	...
	UnwarnSendToModlog          whereHelpernull_Bool
	UnwarnIncludeWarnReason     whereHelpernull_Bool
}{
	...
	UnwarnSendToModlog:          whereHelpernull_Bool{field: "\"moderation_configs\".\"unwarn_send_to_modlog\""},
	UnwarnIncludeWarnReason:     whereHelpernull_Bool{field: "\"moderation_configs\".\"unwarn_include_warn_reason\""},
}
