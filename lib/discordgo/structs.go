...
type CreateApplicationCommandRequest struct {
	...
	IntegrationTypes  []int                       `json:"IntegrationTypes"`             // Defines the integration types a command supports https://discord.com/developers/docs/resources/application#application-object-application-integration-types
