...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `When I witnessed somequack %s this morning, I knew it wouldn’t be your average con.`},
		...
		Responses: []ResponseCard{
			...
			`seeing somequack cosplay a spoiler that came out a week ago`,
			...
			`Somequack spiking the water coolers`,
			`Somequack taking a shit in the elevator`,
			`Special Snowflakes`,
