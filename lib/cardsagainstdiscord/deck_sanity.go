...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			{Prompt: `%s should never be allowed in a convention.`},
			{Prompt: `%s, now happening at a convention near you!`},
			{Prompt: `%s. Worst Decision I've ever made.`},
			{Prompt: `%s. An experience I‘ll never forget.`},
			{Prompt: `%s sucks some major dick.`},
			{Prompt: `After last year, the con got an ambulance on standby in case %s happened again.`},
			{Prompt: `Attention all guests: We regret to inform you that the game room will be closed for the rest of the convention due to %s.`},
			{Prompt: `At the con I decided that %s was a good idea. Go me.`},
			{Prompt: `Come place your bets, ladies and gentlemen! %s vs. %s. Who will win?`},
			{Prompt: `Follow me at: %s.tumblr.com`},
			{Prompt: `I got a refund when my favorite voice actor’s panel was canceled for a three-hour seminar on %s.`},
			{Prompt: `I won the cosplay contest because I had (a) %s.`},
			{Prompt: `If you see %s, say nothing and drink to forget.`},
			{Prompt: `My entire convention weekend was ruined by %s.`},
			{Prompt: `Next year’s main panel: %s, Confessions of a Life-Long Con Owner.`},
			{Prompt: `One day when I have kids, I’ll be able to sit them all down and tell them the story of %s.`},
			{Prompt: `Please go like my page “%s Cosplay”. It’s got almost 100 followers!`},
			{Prompt: `Scott McNeil said he wouldn't show up to another convention if %s were there.`},
			{Prompt: `Screw the rules! I have %s!`},
			{Prompt: `There are conventions themed around gaming, anime, and comic books. But you wouldn't believe what the next convention’s theme is…`},
			{Prompt: `What did I forget to pack for this convention?`},
			{Prompt: `What do you mean they ran out of %s? This after-party sucks!`},
			{Prompt: `What the fuck is wrong with my life?`},
			{Prompt: `When I witnessed someone %s this morning, I knew it wouldn’t be your average con.`},
			{Prompt: `You can't say you've had the full convention experience until you’ve seen %s and %s .`},
		},
