...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `%s is definitely better than sex!`},
			&PromptCard{Prompt: `%s is definitely how I'd like to see Jar Jar Binks die.`},
			...
			&PromptCard{Prompt: `Anakin - "I hate you" Obi Wan - "You were my %s Anakin, I loved you!`},
			&PromptCard{Prompt: `Anakin and Padme's relationship was as awkward as %s.`},
			&PromptCard{Prompt: `Anakin didn't want to kill younglings, until he found out they were doing %s.`},
		...
		Responses: []ResponseCard{
			...
			`a diet consisting solely of Trandoshani flatcakes`,
			...
			`accidentally turning on a lightsaber when you're masturbating with it`,
			...
			`an accidental circumcision with a lightsaber`,
			...
			`being such an asshole that even the sith didn't want you`,
			...
			`boring missionary sex with a Star Wars princess`,
			`Boss Nass`,
			...
			`Finn; the token black character`,
			...
			`General Grievous`,
			`General Grievous’s long lost Marlboro advert`,
			...
			`having anatomically improbable inter-species sex`,
			...
			`Queen Amidala's surprisingly deep sex noises`,
			`Qui-Gon Jinn`,
			...
			`slowly marinating Ponda Baba’s hacked off arm`,
			...
			`sneaking past stormtroopers like a boss`,
