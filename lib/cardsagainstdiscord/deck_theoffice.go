...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `Dwight, At 8AM today, somequack poisons %s. Do not %s. More instructions will follow. Cordially, future Dwight.`},
		...
		Responses: []ResponseCard{
			...
			`Calling somequack ASAP as possible`,
			...
			`When you hate to see somequack leave, but love to watch them go. Cause of their butt`,
