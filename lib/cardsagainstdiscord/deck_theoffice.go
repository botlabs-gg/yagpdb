...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			{Prompt: `The bigger the %s, the more powerful the man. - Dwight Schrute`},
			{Prompt: `What is the most romantic thing in The Office? %s`},
			{Prompt: `Why was The Office so great? %s`},
			{Prompt: `Assistant to the Regional %s.`},
			{Prompt: `Break me off a piece of that %s.`},
			{Prompt: `%s is not a joke Jim! Millions of families suffer every year!`},
			{Prompt: `You don't know me; you've just seen my %s.`},
			{Prompt: `Dwight, At 8AM today, someone poisons %s. Do not %s. More instructions will follow. Cordially, future Dwight.`},
			{Prompt: `%s. Nope. Don't like that.`},
			{Prompt: `I started with a thumb tack and traded my way to a telescope, but in a way the most valuable thing here wasn't the telescope... It was %s.`},
			{Prompt: `The dundie for funniest in the office goes to %s.`},
			{Prompt: `I need a username, and... I have a great one. "%s." That way people will know exactly where my priorities are at.`},
			{Prompt: `Beer me %s.`},
			{Prompt: `Dwight, you %s!`},
			{Prompt: `I have flaws. What are they? I sing in the shower. Sometimes I spend too much time volunteering. Occasionally I'll %s. So sue me.`},
			{Prompt: `Well happy birthday Jesus. Sorry your %s's so lame.`},
			{Prompt: `If I have to do this based on stereotypes that are totally untrue, that I do not agree with, you would maybe not be a very good driver. "Oh, man, am I %s?"`},
			{Prompt: `Friends joke with one another. "Hey, you're poor." "Hey, your momma's dead." "Hey you're %s."`},
			{Prompt: `Hey Mr. Scott, whatcha gonna do, whatcha gonna do? %s.`},
			{Prompt: `The doobie doobie pothead stoner of the year dundie goes to %s.`},
			{Prompt: `What is Michael's worst fear? %s`},
			{Prompt: `What does Michael hate more than Toby? %s`},
			{Prompt: `The subject of today's conference meeting: %s.`},
			{Prompt: `The party planning committee decided on a %s themed Christmas party this year.`},
			{Prompt: `Bears. Beets. %s.`},
			{Prompt: `If I had a gun with two bullets and I was in a room with %s and Toby, I would shoot Toby twice.`},
			{Prompt: `%s. That's what she said!`},
			{Prompt: `%s. How the turntables...`},
			{Prompt: `You miss 100 percent of the %s you don't take. - Wayne Gretzky - Michael Scott`},
			{Prompt: `What's the ratio of Stanley Nickels to Schrute Bucks? The same as the ratio of %s to %s.`},
			{Prompt: `Make %s first, make sales second, make love third. In no particular order.`},
			{Prompt: `You know what's even cooler than a triceratops? %s.`},
			{Prompt: `Jim put my %s in jello again!`},
			{Prompt: `Who should've replaced Michael as regional manager? %s.`},
			{Prompt: `The hardest thing about working at Dunder Mifflin is %s.`},
			{Prompt: `What makes Dwight, Dwight? %s`},
		},
