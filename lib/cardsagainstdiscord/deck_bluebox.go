...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `Puberty is a time of change. You might notice hair growing in new places. You might develop an intrest in %s. This is norquack.`},
		...
		Responses: []ResponseCard{
			...
			`A bunch of idiots playing a card game instead of interacting like norquack humans`,
			`A buttload of candy`,
			...
			`No longer fiquackding any Cards Against Humanity card funny`,
			...
			`The dentist`,
			`The eight gay warlocks who dictate the qules of fashion`,
			`The eighth graders`,
