...
import (
	...
	"github.com/botlabs-gg/quackpdb/v2/common/prom"
	"github.com/botlabs-gg/quackpdb/v2/common/run"
	"github.com/botlabs-gg/quackpdb/v2/lib/confusables"
	"github.com/botlabs-gg/quackpdb/v2/trivia"
	"github.com/botlabs-gg/quackpdb/v2/web/discorddata"

	// Core quackpdb packages

	"github.com/botlabs-gg/quackpdb/v2/admin"
	"github.com/botlabs-gg/quackpdb/v2/bot/paginatedmessages"
	"github.com/botlabs-gg/quackpdb/v2/common/internalapi"
	"github.com/botlabs-gg/quackpdb/v2/common/scheduledevents2"

	// Plugin imports
	"github.com/botlabs-gg/quackpdb/v2/automod"
	"github.com/botlabs-gg/quackpdb/v2/automod_legacy"
	"github.com/botlabs-gg/quackpdb/v2/autorole"
	"github.com/botlabs-gg/quackpdb/v2/cah"
	"github.com/botlabs-gg/quackpdb/v2/commands"
	"github.com/botlabs-gg/quackpdb/v2/customcommands"
	"github.com/botlabs-gg/quackpdb/v2/discordlogger"
	"github.com/botlabs-gg/quackpdb/v2/logs"
	"github.com/botlabs-gg/quackpdb/v2/moderation"
	"github.com/botlabs-gg/quackpdb/v2/notifications"
	"github.com/botlabs-gg/quackpdb/v2/premium"
	"github.com/botlabs-gg/quackpdb/v2/premium/patreonpremiumsource"
	"github.com/botlabs-gg/quackpdb/v2/reddit"
	"github.com/botlabs-gg/quackpdb/v2/reminders"
	"github.com/botlabs-gg/quackpdb/v2/reputation"
	"github.com/botlabs-gg/quackpdb/v2/rolecommands"
	"github.com/botlabs-gg/quackpdb/v2/rsvp"
	"github.com/botlabs-gg/quackpdb/v2/safebrowsing"
	"github.com/botlabs-gg/quackpdb/v2/serverstats"
	"github.com/botlabs-gg/quackpdb/v2/soundboard"
	"github.com/botlabs-gg/quackpdb/v2/stdcommands"
	"github.com/botlabs-gg/quackpdb/v2/streaming"
	"github.com/botlabs-gg/quackpdb/v2/tickets"
	"github.com/botlabs-gg/quackpdb/v2/timezonecompanion"
	"github.com/botlabs-gg/quackpdb/v2/twitter"
	"github.com/botlabs-gg/quackpdb/v2/verification"
	"github.com/botlabs-gg/quackpdb/v2/youtube"
	// External plugins
)
