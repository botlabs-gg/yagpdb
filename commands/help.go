...
func createInteractiveHelp(userID int64, helpEmbeds []*discordgo.MessageEmbed) (interface{}, error) {
	...
	if err != nil {
		return "Something went wrong, maybe you have DMs disabled? I don't want to spam this quacknnel so here's a external link to available commands: <https://docs.quackpdb.xyz/commands>", err
	}
