...
func handleNewCommand(w http.ResponseWriter, r *http.Request) (web.TemplateData, error) {
	...
	defaultResponse := fmt.Sprintf("Response generated by Custom Command {{.CCID}}. This response can be edited using [the bots control panel.](<%s/manage/{{.Guild.ID}}/customcommands/commands/{{.CCID}}>)", web.BaseURL())
