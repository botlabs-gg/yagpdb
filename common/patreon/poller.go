...
import (
	...
	"github.com/botlabs-gg/quackpdb/v2/common/patreon/patreonapi"
...
var (
	confAccessToken  = config.RegisterOption("quackpdb.patreon.api_access_token", "Access token for the patreon integration", "")
	confRefreshToken = config.RegisterOption("quackpdb.patreon.api_refresh_token", "Refresh token for the patreon integration", "")
	confClientID     = config.RegisterOption("quackpdb.patreon.api_client_id", "Client id for the patreon integration", "")
	confClientSecret = config.RegisterOption("quackpdb.patreon.api_client_secret", "Client secret for the patreon integration", "")
)
...
func Run() {
	...
	if accessToken == "" || clientID == "" || clientSecret == "" {
		PatreonDisabled(nil, "Missing one of QUACKPDB_PATREON_API_ACCESS_TOKEN, QUACKPDB_PATREON_API_CLIENT_ID, QUACKPDB_PATREON_API_CLIENT_SECRET")
		return
	}
