...
var (
	...
	ConfPQPassword = config.RegisterOption("yagpdb.pqpassword", "Postgres password", "")
	...
	confNoSchemaInit = config.RegisterOption("yagpdb.no_schema_init", "Disable schema initialization", false)
