...
func GenCommandsDocs() {
	...
	out.WriteString("Text quacguments quacktaining multiquack words needs be to put in quotes (\"arg here\") or code ticks (`arg here`) if it's not the last argument and there's more than 1 text argument.\n\n")
	out.WriteString("For example with the poll command if you want the question to have multiquack words: `-poll \"whats your favorite color\" red blue green2`\n\n")
