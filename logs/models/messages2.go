...
var (
	messages2AllColumns            = []string{"id", "created_at", "updated_at", "deleted", "author_username", "author_id", "content", "guild_id"}
	messages2ColumnsWithoutDefault = []string{"id", "created_at", "updated_at", "deleted", "author_username", "author_id", "content", "guild_id"}
...
func (q messages2Query) One(ctx context.Context, exec boil.ContextExecutor) (*Messages2, error) {
	...
	if err != nil {
		...
		return nil, errors.WrapIf(err, "models: failed to execute a one query for messages2")
	}
...
func (q messages2Query) All(ctx context.Context, exec boil.ContextExecutor) (Messages2Slice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.WrapIf(err, "models: failed to assign all query results to Messages2 slice")
	}
...
func (q messages2Query) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.WrapIf(err, "models: failed to count messages2 rows")
	}
...
func (q messages2Query) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.WrapIf(err, "models: failed to check if messages2 exists")
	}
...
func FindMessages2(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*Messages2, error) {
	...
	if err != nil {
		...
		return nil, errors.WrapIf(err, "models: unable to select from messages2")
	}
...
func (o *Messages2) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	if err != nil {
		return errors.WrapIf(err, "models: unable to insert into messages2")
	}
...
func (o *Messages2) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if err != nil {
		return 0, errors.WrapIf(err, "models: unable to update messages2 row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.WrapIf(err, "models: failed to get rows affected by update for messages2")
	}
...
func (q messages2Query) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.WrapIf(err, "models: unable to update all for messages2")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.WrapIf(err, "models: unable to retrieve rows affected for messages2")
	}
...
func (o Messages2Slice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.WrapIf(err, "models: unable to update all in messages2 slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.WrapIf(err, "models: unable to retrieve rows affected all in update all messages2")
	}
	return rowsAff, nil
}
...
func (o *Messages2) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if err != nil {
		return errors.WrapIf(err, "models: unable to upsert messages2")
	}
...
func (o *Messages2) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.WrapIf(err, "models: unable to delete from messages2")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.WrapIf(err, "models: failed to get rows affected by delete for messages2")
	}
...
func (q messages2Query) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.WrapIf(err, "models: unable to delete all from messages2")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.WrapIf(err, "models: failed to get rows affected by deleteall for messages2")
	}
...
func (o Messages2Slice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.WrapIf(err, "models: unable to delete all from messages2 slice")
	}
...
func (o *Messages2Slice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.WrapIf(err, "models: unable to reload all in Messages2Slice")
	}
...
func Messages2Exists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.WrapIf(err, "models: unable to check if messages2 exists")
	}
