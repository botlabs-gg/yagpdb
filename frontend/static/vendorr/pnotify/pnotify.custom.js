(function (factory) {
  ...
  $.extend(PNotify.prototype, {
      ...
      for (var module in this.modules) {
        ...
        if (typeof this.modules[module][event] === "function")
          this.modules[module][event](
            this,
            typeof this.options[module] === "object"
              ? this.options[module]
              : {},
            curArg
          );
    ...
    init: function () {
        ...
        mouseenter: function (e) {
          if (that.options.mouse_reset && that.animating === "out") {
            ...
            that.elem
              .css("height", "auto")
              .animate(
                { width: that.options.width, opacity: that.options.opacity },
                "fast"
              );
          }
      ...
      this.text_container = $("<div />", { class: "ui-pnotify-text" }).appendTo(
        this.container
      );
      ...
      else PNotify.notices = $.merge(PNotify.notices, [this]);
    ...
    update: function (options) {
      ...
      if (this.options.cornerclass !== oldOpts.cornerclass)
        this.container
          .removeClass("ui-corner-all " + oldOpts.cornerclass)
          .addClass(this.options.cornerclass);
      ...
      if (
        this.options.icon !== oldOpts.icon ||
      ...
      else if (!oldOpts.hide) this.queueRemove();
    ...
    animateIn: function (callback) {
      ...
      else animation = this.options.animation;
      if (animation === "none") {
        this.elem.show();
        callback();
        ...
        this.elem
          .show()
          .fadeTo(this.options.animate_speed, this.options.opacity, callback);
    ...
    position: function (dontSkipHidden) {
      ...
      if (!hidden || dontSkipHidden) {
        ...
        curpos1 = parseInt(
          this.elem.css(csspos1).replace(/(?:\..*|[^0-9.])/g, "")
        );
        ...
        curpos2 = parseInt(
          this.elem.css(csspos2).replace(/(?:\..*|[^0-9.])/g, "")
        );
  ...
  PNotify.prototype.modules.buttons = {
    ...
    init: function (notice, options) {
      ...
      this.sticker = $("<div />", {
        ...
        click: function () {
          ...
          if (notice.options.hide) notice.queueRemove();
          else notice.cancelRemove();
        ...
        .bind("pnotify_icon", function () {
          $(this)
            .children()
            .removeClass(notice.styles.pin_up + " " + notice.styles.pin_down)
            .addClass(
              notice.options.hide
                ? notice.styles.pin_up
    ...
    update: function (notice, options) {
      ...
      if (
        ...
        this.closer.css("display", "none");
      else if (options.closer) this.closer.css("display", "block");
      if (
        !options.sticker ||
        (notice.options.nonblock && notice.options.nonblock.nonblock)
      )
        this.sticker.css("display", "none");
      else if (options.sticker) this.sticker.css("display", "block");
      this.sticker.trigger("pnotify_icon");
      if (options.sticker_hover) this.sticker.css("visibility", "hidden");
      else if (!(notice.options.nonblock && notice.options.nonblock.nonblock))
        this.sticker.css("visibility", "visible");
      if (options.closer_hover) this.closer.css("visibility", "hidden");
      else if (!(notice.options.nonblock && notice.options.nonblock.nonblock))
  ...
  PNotify.prototype.modules.confirm = {
    ...
    init: function (notice, options) {
      this.buttonContainer = $(
        '<div style="margin-top:5px;clear:both;text-align:' +
          options.align +
          ';" />'
      ).appendTo(notice.container);
      if (options.confirm) this.makeButtons(notice, options);
      else this.buttonContainer.hide();
    },
    update: function (notice, options) {
      if (options.confirm) {
    ...
    makeButtons: function (notice, options) {
      ...
      for (var i in options.buttons) {
        ...
        if (already) this.buttonContainer.append(" ");
        else already = true;
        elem = $(
  ...
  $(function () {
    $("body")
      ...
      .on("pnotify.history-last", function () {
        ...
        var notice;
        do {
          if (i === -1) notice = PNotify.notices.slice(i);
          else notice = PNotify.notices.slice(i, i + 1);
    ...
    beforeOpen: function (notice, options) {
      if (PNotify.notices && PNotify.notices.length > options.maxonscreen) {
        ...
        if (notice.options.stack.push !== "top")
          el = PNotify.notices.slice(
            0,
            PNotify.notices.length - options.maxonscreen
          );
        else
          el = PNotify.notices.slice(
            options.maxonscreen,
            PNotify.notices.length
          );
        $.each(el, function () {
          if (this.remove) this.remove();
        });
      ...
      notice.elem.on({
        mouseenter: function (e) {
          ...
          if (that.myOptions.nonblock) {
            notice.elem
              .stop()
              .animate({ opacity: that.myOptions.nonblock_opacity }, "fast");
          }
        },
        mouseleave: function (e) {
          if (that.myOptions.nonblock) e.stopPropagation();
          ...
          if (that.myOptions.nonblock && notice.animating !== "out")
            notice.elem
              .stop()
              .animate({ opacity: notice.options.opacity }, "fast");
        },
...
(function ($) {
  ...
  PNotify.prototype.modules.reference = {
    ...
    update: function (notice, options, oldOpts) {
      if (options.putThing && this.thingElem) this.thingElem.show();
      else if (!options.putThing && this.thingElem) this.thingElem.hide();
      if (this.thingElem)
  ...
  $.extend(PNotify.styling.fontawesome, { athing: "fas fa-sync" });
})(jQuery);
