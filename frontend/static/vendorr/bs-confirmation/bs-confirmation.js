...
+(function ($) {
  ...
  Confirmation.prototype.getBtnOkClass = function () {
    return (
      this.$element.data("btnOkClass") ||
      (typeof this.options.btnOkClass == "function"
        ? this.options.btnOkClass.call(this, this.$element)
        : this.options.btnOkClass)
    );
  };

  Confirmation.prototype.getBtnOkLabel = function () {
    return (
      this.$element.data("btnOkLabel") ||
      (typeof this.options.btnOkLabel == "function"
        ? this.options.btnOkLabel.call(this, this.$element)
        : this.options.btnOkLabel)
    );
  };

  Confirmation.prototype.getBtnOkIcon = function () {
    return (
      this.$element.data("btnOkIcon") ||
      (typeof this.options.btnOkIcon == "function"
        ? this.options.btnOkIcon.call(this, this.$element)
        : this.options.btnOkIcon)
    );
  };

  Confirmation.prototype.getBtnCancelClass = function () {
    return (
      this.$element.data("btnCancelClass") ||
      (typeof this.options.btnCancelClass == "function"
        ? this.options.btnCancelClass.call(this, this.$element)
        : this.options.btnCancelClass)
    );
  };

  Confirmation.prototype.getBtnCancelLabel = function () {
    return (
      this.$element.data("btnCancelLabel") ||
      (typeof this.options.btnCancelLabel == "function"
        ? this.options.btnCancelLabel.call(this, this.$element)
        : this.options.btnCancelLabel)
    );
  };

  Confirmation.prototype.getBtnCancelIcon = function () {
    return (
      this.$element.data("btnCancelIcon") ||
      (typeof this.options.btnCancelIcon == "function"
        ? this.options.btnCancelIcon.call(this, this.$element)
  ...
  Confirmation.prototype.getTitle = function () {
    return (
      this.$element.data("confirmation-title") ||
      this.$element.data("title") ||
      this.$element.attr("title") ||
      (typeof this.options.title == "function"
        ? this.options.title.call(this, this.$element)
        : this.options.title)
    );
  };
  ...
  Confirmation.prototype.getHref = function () {
    return (
      ...
      (typeof this.options.href == "function"
        ? this.options.href.call(this, this.$element)
        : this.options.href)
    );
  };
  ...
  Confirmation.prototype.getTarget = function () {
    return (
      ...
      (typeof this.options.target == "function"
        ? this.options.target.call(this, this.$element)
        : this.options.target)
    );
  };
  ...
  Confirmation.prototype.isPopout = function () {
    var popout =
      this.$element.data("popout") ||
      (typeof this.options.popout == "function"
        ? this.options.popout.call(this, this.$element)
        : this.options.popout);
