      ...
      18: [
        function (a, b, c) {
          ...
          (g.prototype.evalPlugin = function (a, b, c, d, f) {
            var g, h, i, j, k, l;
            (k = b.pluginManager),
              f && (l = "string" == typeof f ? f : f.filename);
            ...
            if (l && (i = k.get(l))) {
              ...
              try {
                ...
                return (
                  (n.message = "Error during @plugin call"),
                  new this.less.LessError(n, c, l)
                );
              }
              return i;
            }
            (j = { exports: {}, pluginManager: k, fileInfo: f }),
              (h = e.create());
            var o = function (a) {
              i = a;
            };
            try {
              (g = new Function(
                ...
                g(j, this.require, o, h, this.less.tree, this.less, f);
            } catch (n) {
              return new this.less.LessError(n, c, l);
            }
            if ((i || (i = j.exports), (i = this.validatePlugin(i, l, m)), !i))
              return new this.less.LessError({ message: "Not a valid plugin" });
            k.addPlugin(i, f.filename, h),
              (i.functions = h.getLocalFunctions()),
              (i.imports = c),
              (i.filename = l),
              this.trySetOptions(i, l, m, d);
            try {
      ...
      34: [
        function (a, b, c) {
          ...
          b.exports = function (a) {
            ...
            return (
              (b.prototype.push = function (b, c, h, i, j) {
                var k = this,
                ...
                var m = function (a, c, d) {
                    ...
                    i.optional && a
                      ? j(null, { rules: [] }, !1, null)
                      : (k.files[d] || (k.files[d] = { root: c, options: i }),
                        a && !k.error && (k.error = a),
                        j(a, c, e, d));
                  },
                  n = {
                ...
                var p,
                  q = function (a) {
                    ...
                    (n.currentDirectory = o.getPath(c)),
                      n.relativeUrls &&
                        ((n.rootpath = o.join(
                          k.context.rootpath || "",
                          o.pathDiff(n.currentDirectory, n.entryPath)
                        )),
                        !o.isPathAbsolute(n.rootpath) &&
                          o.alwaysMakePathsAbsolute() &&
                          (n.rootpath = o.join(n.entryPath, n.rootpath))),
                      (n.filename = c);
                    var j = new d.Parse(k.context);
                    (j.processImports = !1),
                      (k.contents[c] = g),
                      (h.reference || i.reference) && (n.reference = !0),
                      i.isPlugin
                        ? ((b = l.evalPlugin(g, j, k, i.pluginArgs, n)),
                          b instanceof f ? m(b, null, c) : m(null, b, c))
                        : i.inline
                        ? m(null, g, c)
                        : !k.files[c] ||
                          k.files[c].options.multiple ||
                          i.multiple
                        ? new e(j, k, n).parse(g, function (a, b) {
                            m(a, b, c);
                          })
                        : m(null, k.files[c].root, c);
                  },
                  r = g.clone(this.context);
                c && (r.ext = i.isPlugin ? ".js" : ".less"),
                  (p = i.isPlugin
                    ? l.loadPlugin(b, h.currentDirectory, r, a, o)
                    : o.loadFile(b, h.currentDirectory, r, a, function (a, b) {
                        a ? m(a) : q(b);
                      })),
                  p && p.then(q, m);
              }),
        ...
        function (a, b, c) {
          ...
          b.exports = function (b, c, j) {
            var k = function (b, c, l) {
              if (
                ("function" == typeof c
                  ? ((l = c), (c = i.defaults(this.options, {})))
                  : (c = i.defaults(this.options, c || {})),
                !l)
              ) {
                d ||
                ...
                parsers: (p = {
                  ...
                  entities: {
                    ...
                    color: function () {
                      ...
                      if (
                        "#" === q.currentChar() &&
                        (a = q.$re(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})/))
                      ) {
                        var b = a.input.match(/^#([\w]+).*/);
                        return (
                          (b = b[1]),
                          b.match(/^[A-Fa-f0-9]+$/) ||
                            j("Invalid HEX color code"),
                  ...
                  mixin: {
                    call: function () {
                      ...
                      if ("." === i || "#" === i) {
                        ...
                        return b &&
                          (q.$char("(") && ((h = this.args(!0).args), m(")")),
                          p.important() && (j = !0),
                          p.end())
                          ? (q.forget(), new e.mixin.Call(b, h, k, c, j))
                          : void q.restore();
                      }
                    },
                    args: function (a) {
                      ...
                      if (
                        ...
                        if (
                          ...
                          if (
                            ...
                            return (
                              q.forget(), new e.Declaration(a, b, !1, f, h, c)
                            );
                          b || (b = this.value()), (d = this.important());
                        }
                        if (b && this.end())
                          return (
                            q.forget(), new e.Declaration(a, b, d, f, h, c)
                          );
                        q.restore();
                      } else q.restore();
                  },
                  ...
                  mediaFeatures: function () {
                    ...
                    do
                      if ((a = this.mediaFeature())) {
                        ...
                        ((a = b.variable()), a && (c.push(a), !q.$char(",")))
                      )
                        break;
                    while (a);
        ...
        function (a, b, c) {
          ...
          b.exports = function (b, c, f) {
            var g = function (b, f, h) {
              if (
                ("function" == typeof f
                  ? ((h = f), (f = e.defaults(this.options, {})))
                  : (f = e.defaults(this.options, f || {})),
                !h)
              ) {
                d ||
                  (d = "undefined" == typeof Promise ? a("promise") : Promise);
