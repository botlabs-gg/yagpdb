...
func (o *AutomodRuleset) GetRulesetAutomodRules() AutomodRuleSlice {
	if o == nil {
		return nil
	}

	return o.R.GetRulesetAutomodRules()
}
...
func (o *AutomodRuleset) GetRulesetAutomodRulesetConditions() AutomodRulesetConditionSlice {
	if o == nil {
		return nil
	}

	return o.R.GetRulesetAutomodRulesetConditions()
}
