...
func (o *TwitterFeed) UpsertG(ctx context.Context, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	return o.Upsert(ctx, boil.GetContextDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns, opts...)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *TwitterFeed) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(twitterFeedAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(twitterFeedPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert twitter_feeds, could not build conflict column list")
			}

			conflict = make([]string, len(twitterFeedPrimaryKeyColumns))
			copy(conflict, twitterFeedPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"twitter_feeds\"", updateOnConflict, ret, update, conflict, insert, opts...)
...
// Exists checks if the TwitterFeed row exists.
func (o *TwitterFeed) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return TwitterFeedExists(ctx, exec, o.ID)
}
